...
import avalanche.models.sparse_resnet18_utils.functional.k_winners as F
from avalanche.models.sparse_resnet18_utils.duty_cycle_metrics import binary_entropy, max_entropy
